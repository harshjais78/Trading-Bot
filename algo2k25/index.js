    ...
    try {
        ...
        for (const coin of prices) {
            ...
            if (profitPercent >= profitPercentThreshold) {
                sellCoin(market, last_price, `Take Profit (${profitPercentThreshold}%)`);
                continue;
            }
            ...
            if (lossPercent >= lossPercentThreshold) {
                sellCoin(market, last_price, "Stop Loss (≥10%)");
